...
class PatientprofilesController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('patientprofile',
                compact('user','basicinfos','pasthistories','surgicalhistories', 
                        'allergies','accidents','specialneeds','bloodtransfusions', 
                        'familyhistories','miscarriages','prescriptions'
                        ));
    }
    ...
    public function searchPatient(Request $request)
    {
        ...
        $miscarriages = Miscarriage::where('patientprofile_id',$profile_id)->get();
        $prescriptions = Prescription::where('patientprofile_id',$profile_id)->get();
        return view('patientprofile',compact('user','basicinfos','pasthistories', 
                'surgicalhistories','allergies','accidents','specialneeds', 
                'bloodtransfusions','familyhistories','miscarriages','prescriptions'
                ));
    }
