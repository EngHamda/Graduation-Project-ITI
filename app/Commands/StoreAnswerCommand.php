...
class StoreAnswerCommand  extends Command implements SelfHandling {
    ...
    public $question_id         ;
    public $physician_id        ;
    public function __construct($answer_specific, $answer_detail, $answer_speciality, $question_id, $physician_id) {
