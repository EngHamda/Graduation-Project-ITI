            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class='col-sm-10 col-sm-offset-2'>
                        {!! Form::submit('Create Question', array('class'=>'btn btn-success col-sm-offset-2', 'style' =>'margin-left: 60px;')) !!}                               
                        {!! Form::reset('Cancel Question', array('class'=>'btn btn-danger col-sm-offset-6', 'style' =>'margin-left: 190px;')) !!}                               
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
