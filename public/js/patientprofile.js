...
$('#patient_profile_form') .on('click', '#add', function(){
        ...
        var html = '<div class="row">'+'<div id="line">' + '<div class="col-md-4">'+
            ...
            '</div>'+'<div class="col-md-4">'+
            '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +'</div>'
        '</div>'+ '</div>'  +'<br>';
...
$('#patient_profile_form') .on('click', '#addsurgical', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count_surgical +'"         value="' + value + '"  id="surgical'+ count_surgical +'" />'+'</div>' +'<div class="col-md-4">'
        +'<input class="form-control" type="text"    name=" name' + count_surgical +'"         value="' + value2 + '"  id="sur'+ count_surgical +'" />' +'</div>'+'<div class="col-md-4">'+
        '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +'</div>'
    '</div>'+'</div>'+'<br>';
...
$('#patient_profile_form') .on('click', '#addallergies', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count_allergies +'"         value="' + value + '"  id="allergies'+ count_allergies +'" />'+'</div>' +'<div class="col-md-4">'
        +'<input class="form-control" type="text"    name=" name' + count_allergies +'"         value="' + value2 + '"  id="all'+ count_allergies +'" />' +'</div>'+
        '<div class="col-md-4">'+
...
$('#patient_profile_form') .on('click', '#addaccedent', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count_accedent +'"         value="' + value + '"  id="accedent'+ count_accedent +'" />'+'</div>'+'<div class="col-md-4">'
        +'<input class="form-control" type="text"    name=" name' + count_accedent +'"         value="' + value2 + '"  id="acc'+ count_accedent +'" />' +'</div>'+
        '<div class="col-md-4">'+  '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +'<div>'+
        '</div>'+ '</div>';
...
$('#patient_profile_form') .on('click', '#addspecialneeds', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-8">'+
        '<input class="form-control" type="text"    name=" name' + count +'"         value="' + value + '"  id="specialneeds'+ count_specialneeds +'" />'
        +'</div>'+'<div class="col-md-4">'+
        '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +'</div>'+'</div>'+
        '</div>'+'<br>';
...
$('#patient_profile_form') .on('click', '#addbloodtransfer', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count +'"         value="' + value + '"  id="bloodtransfer'+ count_bloodtransfer +'" />'+'</div>'+'<div class="col-md-4">'
        +'<input class="form-control" type="text"    name=" name' + count +'"         value="' + value2 + '"  id="blood'+ count_bloodtransfer +'" />' +'</div>'+
        '<div class="col-md-4">'+
        '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +'</div>'+'</div>'+
        '</div>'+'<br>';
...
$('#patient_profile_form') .on('click', '#addmis', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count +'"         value="' + value + '"  id="misc'+ count_mis+'" />'+'</div>'+
        '<div class="col-md-4">'+
        '<input class="form-control" type="text"    name=" name' + count +'"         value="' + value2 + '"  id="mis'+ count_mis+'" />' +'</div>'+
        '<div class="col-md-4">'+
        '<input type="button" value="Remove" id="remove" class="btn btn-danger" />' +
        '</div>'+'</div>'+
        '</div>'+'<br>';
...
$('#patient_profile_form') .on('click', '#addp', function(){
    ...
    var value = $('#drug').val();
    var value2=$('#date').val();
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-2">'

        +'<input class="form-control" type="text"    name=" name' + count_p+'"         value="' + value2+ '"  id="date'+ count_p +'" />' +
        '</div>'+'<div class="col-md-2">'+

        '<input class="form-control" type="text"    name=" name' + count +'"         value="' + value+ '"  id="drug'+ count_p +'" />' + '</div>'+

        '<div class="col-md-2">'+
        '<select class="form-control" id="freq'+count_p+'">' + '<option value="Once Per Week">' + 'Once Per Week' + '</option>' +'<option value="Every Three Days" >'+'Every Three Days'+'</option>'+
...
'<option value="Every Two Hours">' + 'Every Two Hours' + '</option>' +
        ...
        '<select class="form-control" id="duration'+count_p+'"">' + '<option value="Year">'+'Year'+ '</option>'+ '<option value="Month">'+ 'Month'+'</option>'+ '<option value="Two Weeks">'+ 'Two Weeks' +'</option>'  + '<option value="Week">' +'Week'+  '</option>'+'<option value="Five Days">'+'Five Days' +'</option>'+'<option value="Three Days">'+'Three Days' +'</option>' + '<option value="Day">' +'Day'+  '</option>' +'</select>' +'</div>'+'<div class="col-md-4">'+
