...
$('#patient_profile_form') .on('click', '#addp', function(){
    ...
    var html = '<div class="row">'+'<div id="line">' +'<div class="col-md-2">'
        ...
        '<div class="col-md-2">'+
        '<select id="freq'+count_p+'">' + '<option value="one">' + 'one' + '</option>' +
        ...
        '<select id="duration'+count_p+'"">' + '<option value="every year">'+'every year'+ '</option>'+ '<option value="everyday">'+ 'every day'+'</option>'+ '<option value="everymonth">'+ 'every month' +'</option>'  + '<option value="every week">' +'every week'+  '</option>'+'<option value="every hour">'+'every hour' +'</option>'   +'</select>' +'</div>'+'<div class="col-md-4">'+
